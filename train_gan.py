...
#all_brain_data, all_brain_data_tags = utils.utils.only_good_classes(all_brain_data, all_brain_data_tags)
#brain_data_shape, brain_data_tag_shape = all_brain_data[0].shape, all_brain_data_tags[0].shape
